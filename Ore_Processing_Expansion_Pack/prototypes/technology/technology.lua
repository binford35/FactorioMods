data:extend(
{
  {
    type = "technology",
    name = "ore_processing_i",
    icon = "__Ore_Processing_Expansion_Pack__/graphics/technology/ore_processing_i.png",
	icon_size = 256,
    effects =
    {
      -- {
  ...
  {
    type = "technology",
    name = "ore_processing_ii",
    icon = "__Ore_Processing_Expansion_Pack__/graphics/technology/ore_processing_ii.png",
	icon_size = 256,
    effects =
    {
      -- {
        -- type = "unlock-recipe",
        -- recipe = "ore_milling_machine"
      -- },
	  
	  -- {
        -- type = "unlock-recipe",
        -- recipe = "froth_flotation_plant"
      -- }
    },
    unit =
    {
	...
	prerequisites = {"ore_processing_i"},
    order = "e-b-b"
  ...
  {
    type = "technology",
    name = "ore_processing_iii",
    icon = "__Ore_Processing_Expansion_Pack__/graphics/technology/ore_processing_iii.png",
	icon_size = 256,
    effects =
    {
      -- {
	...
	prerequisites = {"ore_processing_ii"},
    order = "e-b-c"
  ...
  {
    type = "technology",
    name = "advanced_steel_processing",
    icon = "__Ore_Processing_Expansion_Pack__/graphics/technology/advanced_steel_processing.png",
	icon_size = 256,
    effects =
    {
      -- {
        -- type = "unlock-recipe",
        -- recipe = "pig_iron_pellet"
      -- },
	  
	  -- {
        -- type = "unlock-recipe",
        -- recipe = "oxygen_injected_furnace"
      -- },
	...
	prerequisites = {"ore_processing_iii", "steel-processing"},
    order = "e-b-d"
