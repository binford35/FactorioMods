...
{
  {
    ...
    minable = {mining_time = 1, result = "blast_furnace"},
    max_health = 150,
    corpse = "big-remnants",
    ...
    working_sound =
    {
      sound =
      {
        filename = "__Ore_Processing_Expansion_Pack__/sound/blast_furnace.ogg",
        volume = 0.7
      },
      apparent_volume = 1.5
    },
...
--[[
  ...
  --Assembling Machine 2
  {
    ...
    crafting_categories = {"crafting", "advanced-crafting", "crafting-with-fluid", "industrial-manufacturing"},
    crafting_speed = 0.75,
    energy_source =
    {
      type = "electric",
