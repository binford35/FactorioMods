data:extend(
{

  {
    ...
    result = "synthetic_material"
  },

  -- {
    -- type = "recipe",
    -- name = "pollution_capture_module",
    -- category = "industrial-manufacturing",
    -- enabled = false,
    -- ingredients =
    -- {
      -- {"circuit",5}, {"pipe", 5}, {"storage-tank", 1}, {"iron-plate", 5}
    -- },
    -- result = "pollution_capture_module"
  -- },
  ...
  -- {
    ...
    -- ingredients =
    -- {
      -- {"iron-plate",5}, {"pipe", 20}, {"transport-belt", 5}, {"steel-plate", 10}
    -- },
    -- result = "drilling_rig"
  -- },
  ...
  -- {
    -- type = "recipe",
    -- name = "active_charcoal_filter_module",
    -- category = "industrial-manufacturing",
    -- enabled = false,
    -- ingredients =
    -- {
      -- {"advanced-circuit",5}, {"pipe", 5}, {"storage-tank", 1}, {"iron-plate", 5}
    -- },
    -- result = "active_charcoal_filter_module"
  -- },  
  
  -- {
    -- type = "recipe",
    -- name = "charcoal_furnace",
    -- category = "industrial-manufacturing",
    -- enabled = false,
    -- ingredients =
    -- {
      -- {"stone-brick",10}, {"iron-plate", 5}
    -- },
    -- result = "charcoal_furnace"
  -- },  
  
  -- {
    -- type = "recipe",
    -- name = "charcoal_reactivation_plant",
    -- category = "industrial-manufacturing",
    -- enabled = false,
    -- ingredients =
    -- {
      -- {"circuit",5}, {"advanced-circuit",5}, {"storage-tank", 2}, {"iron-plate", 10}
    -- },
    -- result = "charcoal_reactivation_plant"
  -- },
  ...
  -- {
    ...
    -- ingredients =
    -- {
      -- {"circuit",5}, {"advanced-circuit",5}, {"pipe", 10}, {"storage-tank", 1}, {"iron-plate", 10}, {"copper-plate", 5}
    -- },
    -- result = "air_scrubber"
  -- },
  ...
  -- {
    -- type = "recipe",
    -- name = "electro-static_precipitator",
    -- category = "industrial-manufacturing",
    -- enabled = false,
    -- ingredients =
    -- {
      -- {"advanced-circuit",5}, {"processing-unit",1}, {"pipe", 10}, {"storage-tank", 1}, {"iron-plate", 10}, {"accumulator", 2}
    -- },
    -- result = "electro-static_precipitator"
  -- },
  ...
  -- {
    ...
    -- ingredients =
    -- {
      -- {"advanced-circuit",5}, {"processing-unit",1}, {"storage-tank", 1}, {"iron-plate", 10}, {"effectivity-module-1", 1}
    -- },
    -- result = "baghouse"
  -- },
  ...
  -- {
    -- type = "recipe",
    -- name = "recycling_plant",
    -- category = "industrial-manufacturing",
    -- enabled = false,
    -- ingredients =
    -- {
      -- {"advanced-circuit",5}, {"processing-unit",5}, {"express-transport-belt", 5}, {"express-splitter", 2}, {"steel-plate", 10}, {"smart-inserter", 4}
    -- },
    -- result = "recycling_plant"
  -- },
  ...
  -- {
    ...
    -- ingredients =
    -- {
      -- {"electro-magnet",4}, {"circuit",5}, {"advanced-circuit", 5}, {"iron-gear-wheel", 4}, {"steel-plate", 10}, {"engine-unit", 4}
    -- },
    -- result = "generator"
  -- },
