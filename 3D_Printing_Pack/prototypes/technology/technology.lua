...
{
  {
    type = "technology",
    name = "3d_printing",
    icon = "__3D_Printing_Pack__/graphics/technology/3d_printing.png",
	icon_size = 256,
    effects =
    {
      -- {
        -- type = "unlock-recipe",
        -- recipe = "material_milling_plant"
      -- },
	  -- {
        -- type = "unlock-recipe",
        -- recipe = "3d_manufacturing_plant"
      -- }
    },
    unit =
    {
  ...
  {
    type = "technology",
    name = "pneumatic_vacuum_conveying_systems",
    icon = "__Ore_Processing_Expansion_Pack__/graphics/technology/pneumatic_vacuum_conveying_systems.png",
	icon_size = 256,
    effects =
    {
      -- {
        -- type = "unlock-recipe",
        -- recipe = "powder_hopper"
      -- },
	  
	  -- {
        -- type = "unlock-recipe",
        -- recipe = "pneumatic_conveyance_pipe"
      -- },
	  
	  -- {
        -- type = "unlock-recipe",
        -- recipe = "pneumatic_air_pump"
      -- },
	  
	  -- {
        -- type = "unlock-recipe",
        -- recipe = "pneumatic_blower_package"
      -- }
    },
    unit =
    {
